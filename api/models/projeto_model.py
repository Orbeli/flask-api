...
funcionario_projeto \
    = db.Table('funcionario_projeto',
               db.Column('projeto_id', db.Integer, db.ForeignKey(
                   'projeto.id'), primary_key=True, nullable=False),
               db.Column('funcionario_id', db.Integer, db.ForeignKey(
                   'funcionario.id'), primary_key=True, nullable=False)
               )
